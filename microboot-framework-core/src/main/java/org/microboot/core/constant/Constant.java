...
public class Constant {
    ...
    public static final String SECURITY_GET_AUTHORIZATION_INFO_ROLE_FUNC = "SECURITY_GET_AUTHORIZATION_INFO_ROLE_FUNC";
    public static final String SECURITY_GET_AUTHORIZATION_INFO_PERMISSION_FUNC = "SECURITY_GET_AUTHORIZATION_INFO_PERMISSION_FUNC";
